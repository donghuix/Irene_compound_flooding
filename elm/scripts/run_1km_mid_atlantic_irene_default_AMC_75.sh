...
CASE_NAME=mid_atlantic_1km_irene_default_AMC_75.`date "+%Y-%m-%d-%H%M%S"`
...
finidat = '/compyfs/xudo627/projects/rdycore/1kIrene/mid_atlantic.IC_AMC_75.elm.r.2011-08-26-00000.nc'
