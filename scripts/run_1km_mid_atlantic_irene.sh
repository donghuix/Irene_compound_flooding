...
FSURDAT=/qfs/people/bish218/projects/rdycore/benchmark-problems/irene/matlab_code/elm/surface_dataset_mid_atlantic_c240907.nc
...
CASE_NAME=mid_atlantic_1km_irene.`date "+%Y-%m-%d-%H%M%S"`
...
finidat = '/compyfs/bish218/rdycore/benchmark-problems/irene/elm/mid_atlantic.elm.r.0031-08-26-00000.nc'
